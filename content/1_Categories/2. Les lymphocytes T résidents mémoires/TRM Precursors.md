...
En cas de réponse mémoire secondaire, les lymphocytes T mémoires peuvent aussi se différencier en TRM.  Il a été démontré que les TCM semblent plus aptes à se différencier en TRM, et que les TRM formés de cette manière sont différents des TRM primaires par l'expression de CD103 [[Osborn_PLoSPathog_2019]]. Cependant, une autre étude montre que les Tnaïfs, les Tcm et les Tem ont la même capacité à se différencier en TRM dans les LN [[Heim_bioRxiv_2026]]. De la même manière, les TEX isolés à partir de tumeur sont capable de se différencier en TRM [[Burn_NatImmunol_2026]].
