...
tags:
  ...
  - P/CCL4
  - P/CX3CL1
citekey: Schenkel_NatImmunol_2013
status: Read
dateread: 2026-09-04
articletype: Article
...
>
>**Experiment** : addition of OT-I in precedent mouse, then infection with VSV-OVA, then gp33 peptide injection
>**Results** : Generation of gp33-specific and OVA-specific T cells. Activation of P14 T cells with gp33 lead to accumulation of bystander OT-I in the FRT and reduction in blood/spleen.
>**Experiment** : Depletion of P14 Tcirc, then transfer of OT-I and injection of gp33 peptide
>**Results** : Accumulation of antigen-epxerienced, but not naive OT-I in FRT, indicating that the precedent effect is Tcirc independent.
>
>**Experiment** : Transfer of WT or IFNg-/- OT-I cells
>**Results** : The effect is dependent on IFNg
>**Experiment** : Parabiosis of P14-VV-OVA immunized mouse with naïve mouse that contain OT-I.
>**Results** : P14 did not equilibrated in FRT, indicating no recirculation. When both mouse are injected with gp33, there is accumulation of OT-I in FRT only on P14-containing FRT on the immunized mouse.
>
> %% end Notes %%
...
> > [!Link]
> >
> >  [Full Text PDF](file://C:\Users\10053234\Documents\Thesis_bibliography\Zotero\storage\AYIHCZYV\Schenkel%20et%20al.%20-%202013%20-%20Sensing%20and%20alarm%20function%20of%20resident%20memory%20CD8+%20T%20cells.pdf)
> >.
>
> > [!Cite]
> > Schenkel, J. M., Fraser, K. A., Vezys, V., & Masopust, D. (2013). Sensing and alarm function of resident memory CD8+ T cells. _Nature Immunology_, _14_(5), 509–513. [https://doi.org/10.1038/ni.2568](https://doi.org/10.1038/ni.2568)
>
> > [!Abstract]-
> >
