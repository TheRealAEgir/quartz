...
# MPEC
- Lymphocyte T effecteur précurseur de cellule mémoire (*Memory Precursor Effector Cell* en anglais)
- Les MPEC sont parfois distingués par leur phénotype KLRG1-CD127+
# SLEC
- Lymphocyte T effecteur à courte durée de vie (*Short Lived Effector Cell* en anglais)
- Les SLEC sont parfois distingués par leur phénotype KLRG1+CD127-
# LLEC
- Lymphocyte T effecteur à longue durée de vie (*Long Lived Effector Cell* en anglais)
- Les LLEC sont parfois distingués par leur phénotype KLRG1+CD127+
# EEC
...
---
# ROS
- Espèce réactive de l'oxygène (Reactive Oxygen Species en anglais)
- Les ROS sont un type de molécule obtenues dans un environnement acide. Ces cellules ont un fort pouvoir oxydatif, ce qui peut nuire à la survie des cellules. Certaines cellules immunitaires utilisent les ROS pour détruire leur cible
# TCR
...
# CAR-T cell
- Cellule T à récepteur antigénique chimérique (Chimeric Antigen Receptor T cell en anglais)
- Les CAR-T cell sont des lymphocytes T modifiés pour exprimer un TCR spécifique d'un antigène d'intérêt et avec une signalisation modifiée dans un but thérapeutique.
# ATP
...
- Il existe différentes souches de LCMV, dont les souches LCMV Armstrong et Cl13 qui entrainent des infections aiguë et chronique, respectivement. Ce modèle est largement utilisé pour étudier les différences entre les Teff/Tmem et les Tex. Il existe des lymphocytes T spécifiques d'antigènes du LCMV, comme les lymphocytes T P14 spécifiques du peptide gp33. La spécificité antigénique n'est pas différente entre les deux souches [[Matloubian_JVirol_1993]]. Le LCMV a un tropisme nerveux et peu générer des réponses immunitaires systémiques.
# P14
- Lymphocyte T CD8+ clonal spécifique pour le peptide gp33 du virus LCMV
# OT-I
- Lymphocyte T CD8+ clonal spécifique du peptide SIINFEKL de la protéine ovalbumine (OVA). L'ovalbumine n'étant pas une protéine normalement exprimée par l'Homme ou dans les modèles murins, les lymphocytes OT-I sont souvent utilisé en combinaison avec des lignées de cellules tumorales ou des souches de virus modifiée pour exprimer cette protéine, ce qui résulte en un contrôle de l'activation des lymphocytes.
# OT-I
- Lymphocyte T CD8+ clonal spécifique du peptide SIINFEKL de la protéine ovalbumine (OVA). L'ovalbumine n'étant pas une protéine normalement exprimée par l'Homme ou dans les modèles murins, les lymphocytes OT-I sont souvent utilisé en combinaison avec des lignées de cellules tumorales ou des souches de virus modifiée pour exprimer cette protéine, ce qui résulte en un contrôle de l'activation des lymphocytes.
# OT-II
- Lymphocyte T CD4+ clonal spécifique du peptide SIINFEKL de la protéine ovalbumine (OVA). L'ovalbumine n'étant pas une protéine normalement exprimée par l'Homme ou dans les modèles murins, les lymphocytes OT-II sont souvent utilisé en combinaison avec des lignées de cellules tumorales ou des souches de virus modifiée pour exprimer cette protéine, ce qui résulte en un contrôle de l'activation des lymphocytes.
# OT-III
- Lymphocyte T CD8+ clonal spécifique de faible affinité pour le peptide SIINFEKL de la protéine ovalbumine (OVA). L'ovalbumine n'étant pas une protéine normalement exprimée par l'Homme ou dans les modèles murins, les lymphocytes OT-III sont souvent utilisé en combinaison avec des lignées de cellules tumorales ou des souches de virus modifiée pour exprimer cette protéine, ce qui résulte en un contrôle de l'activation des lymphocytes. Dans le cas des lymphocytes OT-III, ils peuvent être utilisés en comparaison avec les lymphocytes OT-I pour comparer l'effet de l'affinité antigénique.
# HSV
...
# LP
- *Lamina Propria* - Couche de tissu située en dessous de l'épithélium dans les muqueuses, notamment l'intestin
# FRT
- Appareil reproducteur féminin (*Female Reproductive Tract* en anglais) 
# SLO
...
# IL-4
- Interleukine 4
- L'interleukine 4 est une cytokine associée avec les réponses de type Th2.
# IL-5
- Interleukine 5
- L'interleukine 5 est une cytokine associée avec les réponses de type Th2 et particulièrement importante pour les éosinophiles.
# IL-6
- Interleukine 6
- L'interleukine 6 est une cytokine associée avec les réponses de type Th1 et qui joue un rôle pro-inflammatoire.
# IL-7
- Interleukine 7
- L'interleukine 7 joue un rôle majeur dans la survie des lymphocytes T mémoires.
# IL-10
- Interleukine 10
...
- CCL5 est un récepteur de chimiokine dont les récepteurs sont CCR1, CCR3, CCR4 et CCR5.
- CCL5 est impliqué dans l'homing des TRM dans les muqueuses du FRT.
# CCL19
- C-C motif chemokine ligand 19
- CCL19 est un récepteur de chimiokine dont le récepteur est CCR7. Il est notamment impliqué dans la migration des lymphocytes T dans les LN.
# CCL21
- C-C motif chemokine ligand 21
- CCL21 est un récepteur de chimiokine dont le récepteur est CCR7. Il est notamment impliqué dans la migration des lymphocytes T dans les LN.
# CXCL9
...
- CXCL9 est un récepteur de chimiokine dont le récepteur est CXCR5. Il est notamment impliqué dans la migration des lymphocytes B et Tfh et dans la génération des TLS.
# CXCL16
- C-X-C motif chemokine ligand 16
- CXCL9 est un récepteur de chimiokine dont le récepteur est CXCR6.
# CCR4
- C-C chemokine receptor type 4
- CCR4 est un récepteur de chimiokine dont les ligands sont CCL17 et CCL22.
- L'expression de CCR4 peut être utilisée en combinaison avec celle de CCR6 et CXCR3 pour distinguer les populations de lymphocytes CD4 selon leur polarisation ; les lymphocytes Th1 sont CXCR3<sup>+</sup>CCR4<sup>-</sup>CCR6<sup>+</sup>, les lymphocytes Th2 sont CXCR3<sup>-</sup>CCR4<sup>+</sup>CCR6<sup>-</sup> et les lymphocytes Th17 sont CXCR3<sup>-</sup>CCR4<sup>+</sup>CCR6<sup>+</sup>
# CCR6
- C-C chemokine receptor type 6
- CCR7 est un récepteur de chimiokine dont le ligand est CCL20.
- L'expression de CCR6 peut être utilisée en combinaison avec celle de CCR4 et CXCR3 pour distinguer les populations de lymphocytes CD4 selon leur polarisation ; les lymphocytes Th1 sont CXCR3<sup>+</sup>CCR4<sup>-</sup>CCR6<sup>+</sup>, les lymphocytes Th2 sont CXCR3<sup>-</sup>CCR4<sup>+</sup>CCR6<sup>-</sup> et les lymphocytes Th17 sont CXCR3<sup>-</sup>CCR4<sup>+</sup>CCR6<sup>+</sup>
# CCR7
- C-C chemokine receptor type 7
- CCR7 est un récepteur de chimiokine dont les ligands sont CCL19 et CCL21. Il a un rôle important dans la migration des lymphocytes et leur maintien au sein des SLO.
- CCR7 est couramment utilisé pour distinguer les TCM des TEM, ces derniers n'ayant pas la capacité de rentrer dans les SLO. Les TRM ne l'expriment pas non plus.
# CCR8
- C-C chemokine receptor type 8
- CCR8 est un récepteur de chimiokine dont le ligand est CCL1.
# CCR9
- C-C chemokine receptor type 9
- CCR9 est un récepteur de chimiokine dont le ligand est CCL25.
- CCR9 joue un rôle important pour la migration des lymphocytes T dans l'intestin
# CCR10
- C-C chemokine receptor type 10
- CCR10 est un récepteur de chimiokine dont les ligands sont CCL27 et CCL28.
# CXCR3
- C-X-C chemokine Receptor type 3
- CXCR3 est un récepteur de chimiokine dont les ligands majoritaires sont CXCL9, CXCL10 et CXCL11.
- CXCR3 est exprimé par les TRM et permet leur migration dans les NLT.
# CXCR4
- C-X-C chemokine Receptor type 4
- CXCR4 est un récepteur de chimiokine dont les ligands sont CXCL12 et MIF.
- CXCR4 est impliqué dans l'homing des TRM dans le tissu adipeux.
# CXCR5
- C-X-C chemokine Receptor type 5
- CXCR5 est un récepteur de chimiokine dont le ligand est CXCL13.
- CXCR5 est notament exprimé par les lymphocytes Tfh.
# CXCR6
